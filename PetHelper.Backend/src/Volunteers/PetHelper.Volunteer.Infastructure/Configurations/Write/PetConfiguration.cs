...
using PetHelper.Volunteer.Domain;
    ...
    public class PetConfiguration : IEntityTypeConfiguration<Pet>
    {
        public void Configure(EntityTypeBuilder<Pet> builder)
        {
            ...
            builder.ComplexProperty(x => x.Description, tb =>
            {
                tb.Property(d => d.Value)
                    .IsRequired()
                    .HasMaxLength(SharedKernel.Constants.MAX_HIGH_TEXT_LENGTH)
            ...
            builder.ComplexProperty(x => x.Weight, tb =>
            {
                tb.Property(d => d.Value)
                    .IsRequired()
                    .HasMaxLength(SharedKernel.Constants.MAX_MEDIUM_TEXT_LENGTH)
            ...
            builder.ComplexProperty(x => x.PhoneNumber, tb =>
            {
                tb.Property(d => d.Value)
                    .IsRequired()
                    .HasMaxLength(SharedKernel.Constants.MAX_HIGH_PHONE_LENGTH)
