...
namespace PetHelper.Accounts.Infastructure.Migrations
{
    ...
    [Migration("20250304173108_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetHelper.Accounts.Domain.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetHelper.Accounts.Domain.RefreshSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetHelper.Accounts.Domain.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetHelper.Accounts.Domain.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uuid")
                        .HasColumnName("role_id");
            ...
            modelBuilder.Entity("PetHelper.Accounts.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "PetHelper.Accounts.Domain.User.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("PetHelper.Accounts.Domain.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PetHelper.Accounts.Domain.RolePermission", b =>
                {
                    b.HasOne("PetHelper.Accounts.Domain.Permission", "Permission")
                        .WithMany()
                    ...
                    b.HasOne("PetHelper.Accounts.Domain.Role", "Role")
